# APIGuardian Backend Implementation Specification
...
- Database: PostgreSQL for scans, API inventory, findings, policies.
- Queue: Endpoint probe and contract scan jobs.
...
- workspace_id
- name
- domain: 'API contract and security checking'
- status
- owner_user_id
- metadata_json
- created_at
...
1. Create project for API contract and security checking.
...
- Worker can complete the primary API contract and security checking workflow using sample inputs.
