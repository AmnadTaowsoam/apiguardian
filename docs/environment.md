# APIGuardian Environment And Configuration
...
PORT=4307
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/apiguardian
APP_BASE_URL=http://localhost:4307
...
OBJECT_STORAGE_BUCKET=apiguardian-artifacts
GITHUB_TOKEN=
OPENAI_API_KEY=
ANTHROPIC_API_KEY=
SENTRY_DSN=
